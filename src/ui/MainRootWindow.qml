...
ApplicationWindow {
    ...
    property var                _myAddWindow:           myAddWindow
    ...
    header: ToolBar {
        ...
        ////202203修改  取消登录界面设置
        //visible:        !QGroundControl.videoManager.fullScreen && loginPage.visible == false
...
//        source:         "MyAdd.qml"
    ...
    //202203注释 将登录和注册相关的注释掉
    /*Login {
        id: loginPage
        anchors.fill: parent
        visible: false
        z: parent.z + 3
        myAddWindow:_myAddWindow
    }
    RegisterVerify{
...
//    }
    ...
    Connections {
        ...
        onShowMainWindow: {
            loginPage.visible = false
//            myAddWindow.addModelData(SENDDATA.get_playback(),SENDDATA.get_playback_length())
//            console.log("zzzzzzzzz ",myAddWindow.addModelData(SENDDATA.get_playback(),SENDDATA.get_playback_length()))
