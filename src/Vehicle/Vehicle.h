...
public:
    VehicleFlowRateMeterFactGroup(QObject* parent = nullptr);
...
public:
    ...
    Q_PROPERTY(FactGroup* flowratemeter               READ flowratemeterFactGroup               CONSTANT)    //自己添加
...
//    void _handleFlowRateMeterRawInt               (mavlink_message_t& message);    //自己添加
    ...
    void _handleServo         (mavlink_message_t& message);
...
//    bool            _flowrateRawIntMessageAvailable;   //自己添加
    ...
    VehicleFlowRateMeterFactGroup   _flowratemeterFactGroup;    //自己添加
    ...
    static const char* _flowratemeterFactGroupName;      //自己添加
